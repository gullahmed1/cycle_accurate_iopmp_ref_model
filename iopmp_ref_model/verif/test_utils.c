...
/**
  * @brief err_info Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_err_info(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x0064, data , num_bytes);

    // vpi_printf("ERRINFO:::::::::::::::: %x\n", read_register(0x0064, num_bytes));
}

/**
  * @brief mdlck Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_mdlck(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x0040, data , num_bytes);

    // vpi_printf("MDLCK:::::::::::::::: %x\n", read_register(0x0040, num_bytes));
}

/**
  * @brief mdlckh Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_mdlckh(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x0044, data , num_bytes);

    // vpi_printf("MDLCKH:::::::::::::::: %x\n", read_register(0x0044, num_bytes));
}

/**
  * @brief mdcfglck Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_mdcfglck(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x0048, data , num_bytes);

    // vpi_printf("MDCFGLCK:::::::::::::::: %x\n", read_register(0x0048, num_bytes));
}

/**
  * @brief entrylck Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_entrylck(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x004c, data , num_bytes);

    // vpi_printf("ENTRYLCK:::::::::::::::: %x\n", read_register(0x004c, num_bytes));
}

/**
  * @brief mdstall Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_mdstall(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x0030, data , num_bytes);

    // vpi_printf("MDSTALL:::::::::::::::: %x\n", read_register(0x0030, num_bytes));
}

/**
  * @brief mdstallh Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_mdstallh(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x0034, data , num_bytes);

    // vpi_printf("MDSTALLH:::::::::::::::: %x\n", read_register(0x0034, num_bytes));
}

/**
  * @brief rridscp Configurations
  * @param data Value that you want to write in this register.
  * @param num_bytes It could be 4-Byte write or 8-Byte Write.
 **/
void configure_rridscp(reg_intf_dw data, uint8_t num_bytes){
    write_register(0x0038, data , num_bytes);

    // vpi_printf("RRIDSCP:::::::::::::::: %x\n", read_register(0x0038, num_bytes));
}
...
void configure_srcmd_n(uint8_t srcmd_reg, uint16_t srcmd_idx, reg_intf_dw data, uint8_t num_bytes){
    ...
    // vpi_printf("offset is:::::::::::::::: %x\n", (SRCMD_TABLE_BASE_OFFSET + srcmd_reg + (srcmd_idx * 32)));
    // vpi_printf("SRCMDN:::::::::::::::: %x\n", read_register(SRCMD_TABLE_BASE_OFFSET + srcmd_reg + (srcmd_idx * 32), 4));
}
/**
...
void configure_mdcfg_n(uint8_t md_idx, reg_intf_dw data, uint8_t num_bytes){
    ...
    // vpi_printf("MDCFG:::::::::::::::: %x\n", read_register(MDCFG_TABLE_BASE_OFFSET + (md_idx * 4), 4));
}
...
void configure_entry_n(uint8_t entry_reg, uint64_t entry_idx, reg_intf_dw data, uint8_t num_bytes){
    ...
    // vpi_printf("Entry_Table:::%x, Entry_Reg:::%x, Entry_idx:::%x, Data:::%x", ENTRY_TABLE_BASE_OFFSET, entry_reg, entry_idx, data);
    // vpi_printf("\nEntry_CFG:::::::::::::::: %x\n", read_register(ENTRY_TABLE_BASE_OFFSET + entry_reg + (entry_idx * 16), 4));
}
...
void set_hwcfg0_enable(){
    ...
    // vpi_printf("HWCFG0:::::::::::::::: %x\n", read_register(0x0008,4));
    // vpi_printf("HWCFG0:::::::::::::::: %x\n", read_register(0x0258,4));
}
